...
<body>
	<div class="box">
		<h3>草稿箱</h3>
		<div class="actions">
			<form id="searchForm" action="<c:url value="/message/listSave" />" method="post">
				<span>搜索内容：</span>
		...
		<table class="list">
            ...
            <tr>
                ...
                <td>
	                <a title="继续编辑" href="<c:url value="/message/update?id=" />${message.messageId}" >
	                	${ message.subject }
	                </a>
                </td>
                <td>
	...
	<script>
    	function confirmDelete(id){
    		if (confirm("确定要删除码？")) {
    			location.href = '<c:url value="/message/Receive.action?side=send&id=" />' + id
    		}
    	}
    </script>
</body>
