...
<body>
	<div class="box">
		<h3>收件箱</h3>
		<div class="actions">
			<form id="searchForm" action="<c:url value="/message/listReceive.action" />" method="post">
				<span>搜索内容：</span>
			...
			<div>
				<a class="btn btn-primary" href="<c:url value="/message/save.action" />">写邮件</a>
			</div>
		</div>
		<table class="list">
            <tr>
            ...
            <tr>
                ...
                <td>
	                <a title="查看详情" href="<c:url value="/message/detail.action?id=" />${message.messageId}" >
	                	${ message.subject }
	                </a>
                </td>
                <td>
	...
	<script>
    	...
    	function confirmDelete(id){
    		if (confirm("确定要删除码？")) {
    			location.href = '<c:url value="/message/Receive.action?side=receive&id=" />' + id
    		}
    	}
    </script>
</body>
